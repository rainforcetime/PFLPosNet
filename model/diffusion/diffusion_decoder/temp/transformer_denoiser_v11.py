...
class TransformerDenoiser_v11(nn.Module):
    def __init__(self,
        ...
        self.to_3dmm_pos = nn.Linear(self.latent_dim + self.pos_dim, self.pos_dim) if (self.latent_dim + self.pos_dim) != self.pos_dim else nn.Identity()
    ...
    def _forward(
        ...
        pos_sample = torch.cat((sample, past_listener_3dmmenc_pos), dim=-1)
        pos = self.to_3dmm_pos(pos_sample)
