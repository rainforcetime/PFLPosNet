...
from model.diffusion.diffusion_decoder.temp.mlp_mapping import PoseTransformationMLP
...
class TransformerDenoiser_v13(nn.Module):
    def __init__(self,
        ...
        self.pose_transformation_MLP = PoseTransformationMLP(
    ...
    def _forward(
        ...
        sample = self.pose_transformation_MLP(sample, past_listener_3dmmenc_pos)
