...
import os
os.environ['CUDA_VISIBLE_DEVICES'] = '2'  # Make only the first GPU visible
...
def parse_arg():
    ...
    parser.add_argument("--exp_num", type=int, help="the number of the experiment.", default=2)
    # parser.add_argument("--config", type=str, required=True)
    # parser.add_argument("--config", type=str, default="./config/latent_embedder.yaml")
    parser.add_argument("--config", type=str, default="./config/latent_3dmm_embedder.yaml")
