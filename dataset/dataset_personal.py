...
class ReactionDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        listeners_label_personal = torch.tensor([self.listener_labels[idx] for idx in relative_indices_personal])
        # listeners_label_personal = torch.LongTensor([self.listener_labels[idx] for idx in relative_indices_personal])
