...
# python evaluate_for_mp4.py
def parse_arg():
    parser = argparse.ArgumentParser(description="PyTorch Training")
    # for loading the trained-model weights.
    parser.add_argument("--epoch_num", type=int, help="epoch number of saving model weight", default=200)
    parser.add_argument("--exp_num", type=int, help="the number of training experiment.", default=18902)
    ...
    parser.add_argument("--config", type=str, help="config path", default="./config/exp/18902.yaml")
